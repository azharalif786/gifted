...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~C7wWUYST#fggcUgjpgu3Ni2sACS5GQ0e_WXq2VdprvF_xcUAsx1Q",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || '✅️ Status Viewed by AN-Md',
  ...
  OWNER_NAME: process.env.OWNER_NAME || "AWAIS QADIR OFC",
